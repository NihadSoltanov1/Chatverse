...
public class RemoveFriendCommandHandler : IRequestHandler<RemoveFriendCommandRequest, Common.Results.IResult>
{
    ...
    public async Task<Common.Results.IResult> Handle(RemoveFriendCommandRequest request, CancellationToken cancellationToken)
    {
