...
public class AcceptFriendRequestCommandHandler : IRequestHandler<AcceptFriendRequestCommandRequest, Common.Results.IResult>
{
    ...
    public async Task<Common.Results.IResult> Handle(AcceptFriendRequestCommandRequest request, CancellationToken cancellationToken)
    {
