...
public class CreateSocialAccountCommandHandler : IRequestHandler<CreateSocialAccountCommandRequest, Common.Results.IResult>
{
    ...
    public async Task<Common.Results.IResult> Handle(CreateSocialAccountCommandRequest request, CancellationToken cancellationToken)
    {
