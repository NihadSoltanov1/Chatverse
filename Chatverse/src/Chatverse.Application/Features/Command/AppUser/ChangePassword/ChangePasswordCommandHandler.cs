...
public class ChangePasswordCommandHandler : IRequestHandler<ChangePasswordCommandRequest, Common.Results.IResult>
{
    ...
    public async Task<Common.Results.IResult> Handle(ChangePasswordCommandRequest request, CancellationToken cancellationToken)
    {
