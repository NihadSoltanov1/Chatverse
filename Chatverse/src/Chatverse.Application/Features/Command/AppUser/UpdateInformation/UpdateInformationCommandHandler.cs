...
{
    public class UpdateInformationCommandHandler : IRequestHandler<UpdateInformationCommandRequest, IResult>
    {
        ...
        public async Task<IResult> Handle(UpdateInformationCommandRequest request, CancellationToken cancellationToken)
        {
